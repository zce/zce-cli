...
exports.nodeVersionCheck = async () => {
  ...
  exports.log()
  exports.error(`You are using Node.js ${process.version}, but this version of ${pkg.name} requires Node.js ${pkg.engines.node}.`)
  exports.error('Please upgrade your Node.js version before this operation.')
  exports.log()
