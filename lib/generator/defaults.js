...
class Defaults {
  constructor (dest) {
    ...
    const generatorrc = rc(app.getName() + '/generator')
    delete generatorrc._
    delete generatorrc.configs
    delete generatorrc.config

    // last remember answers
    Object.assign(this, generatorrc)
  }
  ...
  static async save (answers) {
    ...
    await mkdir(app.getDataPath('generator'))
    await writeFile(app.getDataPath('generator', 'config'), json)
  }
}
